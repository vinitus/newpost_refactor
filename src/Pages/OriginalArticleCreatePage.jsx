    ...
    >
      ...
      >
        ...
        <div className="flex items-end justify-end w-full h-full">
          <button type="button" className="px-40 py-10 mr-20 bg-gray-200 rounded hover:bg-gray-300" onClick={onCancel}>
            취소
          </button>
          <button
            type="button"
...
const ArticleCreatePage = () => {
  ...
  return (
    <>
      {modalOpen && (
        <AlertModal open={modalOpen} close={modalCloseHandler} onCheck={modalCloseHandler}>
          로그인이 필요한 서비스입니다!
        </AlertModal>
      )}
      {!modalOpen && (
          ...
          <div className="w-1200 mx-auto border-x border-solid border-#7F807F px-203 pt-141">
            ...
            <div className="flex flex-col w-full text-xl">
              ...
              >
                ...
                <SubmitAlertModal open={showAlert} onConfirm={handleConfirm} onCancel={handleCancel} />
              </div>
            </div>
          </div>
        </>
